...
export default function TurfBookingDetailsScreen({navigation}){
    ...
    return (
        <>
            <View style={styles.container}>
                <Text style={styles.heading}>Turf1</Text>
                <View style={[styles.card,styles.elevation]}>
                    <Image source={require('../assets/sample_turf.png')} style={styles.image}/>
                </View>
