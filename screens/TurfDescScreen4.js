...
export default function TurfDescScreen4({navigation}){
    return (
        <>
        <View style={styles.container}>
            <Text style={styles.heading}>Turf 4</Text>
            <View style={[styles.card,styles.elevation]}>
                <Image source={require('../assets/turf4.png')} style={styles.image}/>
            </View>
                ...
                <Text style={styles.subtitle1}>Address</Text>
                    <View style={{flexDirection: 'column', marginTop: 7}}>
                        <View style={{flexDirection: 'row', marginTop: 25, marginLeft: -70}}>
                            ...
                            <Text style={styles.subtitle2} onPress={() => Linking.openURL('https://g.co/kgs/HZCyGx ')}>Open in Map</Text>
                        </View>
                    </View>
            </View>
        ...
        <View style={styles.buttonContainer}>
            <TouchableOpacity
                onPress={() => (navigation.navigate('Turf4Booking'))}
                style={styles.button}
            >
